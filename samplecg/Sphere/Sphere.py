...
def sphere(center, r, stk, sec):
    ...
    for i in vertices:
        if i[0] > 0 and i[1] > 0 and i[2] > 0:
            color += [0, 0, 1]
        elif i[0] < 0 < i[1] and i[2] > 0:
            color += [0, 1, 0]
        elif i[0] > 0 > i[1] and i[2] > 0:
            color += [0, 1, 1]
        elif i[0] < 0 < i[2] and i[1] < 0:
            color += [1, 0, 0]
        elif i[0] > 0 > i[2] and i[1] > 0:
            color += [1, 0, 1]
        elif i[0] < 0 < i[1] and i[2] < 0:
...
def sphere1(depth):
    ...
    for i in range(depth):
        ...
        for triangle in triangles:
            ...
            indices_temp += [indexA, indexD, indexF] + [indexB, indexE, indexD] + [indexC, indexF, indexE] + [indexD,
                                                                                                              indexE,
                                                                                                              indexF]
            triangles_temp += [[indexA, indexD, indexF]] + [[indexB, indexE, indexD]] + [[indexC, indexF, indexE]] + [
...
class Sphere(object):
    def __init__(self, vert_shader, frag_shader, flag):
        self.flag = flag
        if self.flag == 0:
            self.vertices, self.indices, self.colors, self.normals = sphere([0.0, 0.0, 0.0], 20, 50,
                                                                            50)  # center, radius, stacks, sectors
            # - Sphere with stacks and sectors
        else:
